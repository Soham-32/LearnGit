...
namespace ApiTests.v1.Endpoints.BusinessOutcomes.MeetingNotes
{
    ...
    public class GetMeetingNotesTests : BaseV1Test
    {
        ...
        public async Task BusinessOutcome_MeetingNotes_Get_Success()
        {
            var client = await  GetAuthenticatedClient();
            var response = await client.GetAsync<List<BusinessOutcomesMeetingNotesResponse>>(RequestUris.BusinessOutcomeGetMeetingNotes.AddQueryParameter(_queries));
        ...
        [TestMethod]
        [TestCategory("TeamAdmin"), TestCategory("CompanyAdmin"), TestCategory("BLAdmin"), TestCategory("OrgLeader"), TestCategory("SiteAdmin"), TestCategory("Member"), TestCategory("PartnerAdmin")]
        public async Task BusinessOutcome_MeetingNotes_Get_UnAuthenticated()
        {
        ...
        [TestCategory("TeamAdmin"), TestCategory("CompanyAdmin"), TestCategory("BLAdmin"), TestCategory("OrgLeader"), TestCategory("SiteAdmin"), TestCategory("Member"), TestCategory("PartnerAdmin")]
        public async Task BusinessOutcome_MeetingNotes_Get_BadRequest_InValidTeamId()
        {
            var client = await GetAuthenticatedClient();

            var incompleteQuery = new Dictionary<string, object> { { "teamId", "FakeTeamId" } };
            var response = await client.GetAsync<List<BusinessOutcomesMeetingNotesResponse>>(RequestUris.BusinessOutcomeGetMeetingNotes.AddQueryParameter(incompleteQuery));

            Assert.AreEqual(HttpStatusCode.BadRequest, response.StatusCode, "Status code doesn't match");
        }
        [TestMethod]
        [TestCategory("TeamAdmin"), TestCategory("CompanyAdmin"), TestCategory("BLAdmin"), TestCategory("OrgLeader"),TestCategory("Member"), TestCategory("PartnerAdmin")]
        public async Task BusinessOutcome_MeetingNotes_Get_BadRequest_InValidCompanyId()
        {
            var client = await GetAuthenticatedClient();

            var incompleteQuery = new Dictionary<string, object> { { "companyId", "FakeCompanyId" } };
            var response = await client.GetAsync<List<BusinessOutcomesMeetingNotesResponse>>(RequestUris.BusinessOutcomeGetMeetingNotes.AddQueryParameter(incompleteQuery));
        ...
        [TestCategory("KnownDefect")] //Bug Id: 53942
        [TestCategory("TeamAdmin"), TestCategory("CompanyAdmin"), TestCategory("BLAdmin"), TestCategory("OrgLeader"), TestCategory("SiteAdmin"), TestCategory("Member"), TestCategory("PartnerAdmin")]
        public async Task BusinessOutcome_MeetingNotes_Get_BadRequest_NoData()
        {
            var client = await GetAuthenticatedClient();
