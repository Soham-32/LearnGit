...
namespace AgilityHealth_Automation.ObjectFactories.NewNavigation.GrowthPlan
{
    public static class GrowthPlanFactory
    {
        public static GrowthItem GetValidGrowthItem(string assessment = null)
        {
            return new GrowthItem
            {
                ...
                Title = "GI_" + RandomDataUtil.GetGrowthPlanTitle(),
        ...
        public static GrowthItem GetValidUpdatedGrowthItem(string assessment = null)
        {
            return new GrowthItem
            {
                ...
                Title = "updatedGrowthItem_" + RandomDataUtil.GetGrowthPlanTitle(),
                ...
                Size = "3",
                Description = "updated_"+RandomDataUtil.GetGrowthPlanDescription(),
