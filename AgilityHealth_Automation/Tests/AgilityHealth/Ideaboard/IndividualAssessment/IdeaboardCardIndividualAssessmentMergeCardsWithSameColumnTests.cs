...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Ideaboard.IndividualAssessment
{
    ...
    public class IdeaboardCardIndividualAssessmentMergeCardsWithSameColumnTests : IndividualAssessmentBaseTest
    {
        ...
        private static List<CreateCardResponse> _notesCardResponseOfIndividualAssessment1;
        private const int ClickOnVotes = 2;
        ...
        public static void ClassSetup(TestContext _)
        {
            try
            {
                ...
                _notesCardResponseOfIndividualAssessment1 = _setup.CreateIdeaboardCardForIndividualAssessment(_assessmentRequest, Company.Id, _assessment.AssessmentList.First().AssessmentUid, user, true);
        ...
        public void Ideaboard_IndividualAssessment_MergeCards_With_Same_Column()
        {
            ...
            var notesCardText1 = _notesCardResponseOfIndividualAssessment1.FirstOrDefault()?.Card.ItemText.CheckForNull();
            ...
            ideaboardPage.ClickOnVoteUpIconByDimensionAndText(notesColumn, ClickOnVotes, notesCardText);
            ideaboardPage.ClickOnVoteUpIconByDimensionAndText(notesColumn, ClickOnVotes, notesCardText1);

            //Merge cards in the same notes column
            Log.Info($"Merge {notesCardText} card with {notesCardText1} in same {SharedConstants.DimensionNotes} column");
            ideaboardPage.DragAndDropCard(SharedConstants.DimensionNotes, SharedConstants.DimensionNotes, notesCardText,
                0, 90);
            ...
            const int expectedVoteCounts = ClickOnVotes + ClickOnVotes;
