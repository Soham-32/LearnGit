...
using AgilityHealth_Automation.PageObjects.AgilityHealth.Assessment.Dashboard;
using AgilityHealth_Automation.SetUpTearDown;
using AtCommon.Dtos.Companies;
using AtCommon.Dtos.Ideaboard;
using AtCommon.Dtos.Radars;
using AgilityHealth_Automation.PageObjects.AgilityHealth.Assessment.Detail;
...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Ideaboard
{
    ...
    public class IdeaboardCardTeamAssessmentTests : BaseTest
    {
        ...
        private static readonly TeamAssessmentInfo TeamAssessmentInfo = new TeamAssessmentInfo
        {
            ...
            TeamMembers = new List<string> { Constants.TeamMemberName2 },
        ...
        private static User Member => CompanyAdminUserConfig.GetUserByDescription("user 2");
        private readonly string UpdatedCardText = "Values are updated" + CSharpHelpers.RandomNumber();
        ...
        public static void ClassSetup(TestContext testContext)
        {
            try
            {
                ...
                _radar = _setup.GetRadarDetails(Company.Id, SharedConstants.TeamAssessmentType);
                setupUi.AddTeamAssessment(_team.TeamId, TeamAssessmentInfo,_user);
                ...
                setupUi.StartSharingAssessment(_team.TeamId, TeamAssessmentInfo.AssessmentName, _user);
        ...
        public void Ideaboard_TeamAssessment_Create_Cards()
        {
            ...
            var cardText = CSharpHelpers.RandomNumber().ToString();
        ...
        public void Ideaboard_TeamAssessment_Update_Cards()
        {
            ...
            //Creating a card
            _dimensionCardResponseOfTeamAssessment = _setup.CreateIdeaboardCardForTeamAssessment(Company.Id, _radar.Name, _assessmentUid);
        ...
        public void Ideaboard_TeamAssessment_GrowthItems_On_Cards()
        {
            ...
            var login = new LoginPage(Driver, Log);
            var teamAssessmentDashboard = new TAssessmentDashboardPage(Driver, Log);
            var ideaboardPage = new IdeaboardPage(Driver, Log);
            ...
            Assert.IsTrue(growthItemGridViewPage.DoesGiExistWithDescriptionAndCategory(notesCardText, GrowthItemGridViewWidget.GrowthItemType.TeamGi), $"'Team Growth Item' does not exist on radar page with {notesCardText} description");
            Assert.IsTrue(growthItemGridViewPage.DoesGiExistWithDescriptionAndCategory(dimensionCardText, GrowthItemGridViewWidget.GrowthItemType.OrganizationalGi), $"'Organizational Growth Item' does not exist on radar page with {dimensionCardText} description");
            ...
            Assert.IsTrue(growthItemGridViewPage.DoesGiExistWithDescriptionAndCategory(dimensionCardText, GrowthItemGridViewWidget.GrowthItemType.TeamGi), $"'Team Growth Item' does not exist on radar page with {dimensionCardText} description");
            Assert.IsTrue(growthItemGridViewPage.DoesGiExistWithDescriptionAndCategory(notesCardText, GrowthItemGridViewWidget.GrowthItemType.OrganizationalGi), $"'Organizational Growth Item' does not exist on radar page with {notesCardText} description");
            ...
            teamAssessmentDashboard.NavigateToPage(_team.TeamId);
            teamAssessmentDashboard.ClickOnRadar(TeamAssessmentInfo.AssessmentName);
            Assert.IsFalse(growthItemGridViewPage.DoesGiExistWithDescriptionAndCategory(notesCardText, GrowthItemGridViewWidget.GrowthItemType.OrganizationalGi), $"'Organizational Growth Item' does exist on radar page with {notesCardText} description");
            Assert.IsFalse(growthItemGridViewPage.DoesGiExistWithDescriptionAndCategory(dimensionCardText, GrowthItemGridViewWidget.GrowthItemType.TeamGi), $"'Team Growth Item' does exist on radar page with {dimensionCardText} description");
        }
        ...
        public void Ideaboard_TeamAssessment_DragAndDrop_Cards()
        {
            ...
            //Creating Cards
            _notesCardResponseOfTeamAssessment = _setup.CreateIdeaboardCardForTeamAssessment(Company.Id, _radar.Name, _assessmentUid, true, false, User,2);
            _dimensionCardResponseOfTeamAssessment = _setup.CreateIdeaboardCardForTeamAssessment(Company.Id, _radar.Name, _assessmentUid);
        ...
        public void Ideaboard_TeamAssessment_SortCards()
        {
            ...
            //Creating Cards
            _notesCardResponseOfTeamAssessment = _setup.CreateIdeaboardCardForTeamAssessment(Company.Id, _radar.Name, _assessmentUid, true, false,  _user);
            _notesCardResponseOfTeamAssessment1 = _setup.CreateIdeaboardCardForTeamAssessment(Company.Id, _radar.Name, _assessmentUid, true, false, _user);
            _notesCardResponseOfTeamAssessment2 = _setup.CreateIdeaboardCardForTeamAssessment(Company.Id, _radar.Name, _assessmentUid, true, false, _user);
