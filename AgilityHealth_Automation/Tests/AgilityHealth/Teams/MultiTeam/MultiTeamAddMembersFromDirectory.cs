...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Teams.MultiTeam
{
    [TestClass]
    [TestCategory("Teams")]
    public class MultiTeamAddMembersFromDirectory : BaseTest
    {
        ...
        public void MultiTeam_TeamMembers_AddFromDirectory_AddMember()
        {
            ...
            Log.Info("Navigate to edit growth team page and add team member from directory");
            addTeamMemberPage.NavigateToPage(_multiTeamId);
        ...
        [TestMethod]
        [TestCategory("CompanyAdmin")]
        public void MultiTeam_TeamMembers_AddFromDirectory_AddTeam()
        {
            var login = new LoginPage(Driver, Log);
            var addTeamMemberPage = new AddTeamMemberPage(Driver, Log);
            ...
            Log.Info("Navigate to edit growth team page and add team's members from directory");
            addTeamMemberPage.NavigateToPage(_multiTeamId);
