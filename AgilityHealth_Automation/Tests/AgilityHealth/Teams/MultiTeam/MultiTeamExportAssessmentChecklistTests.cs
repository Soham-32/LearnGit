...
{
    [TestClass]
    [TestCategory("Teams"), TestCategory("MultiTeam"), TestCategory("Radars")]
    public class MultiTeamExportAssessmentChecklistTests : BaseTest
    {
        ...
        public static void ClassSetup(TestContext _)
        {
            ...
            _multiTeam = setup.GetCompanyHierarchy(Company.Id)
                .GetTeamByName(Constants.MultiTeamForMtEtGrowthItems)
                .CheckForNull($"<{Constants.MultiTeamForMtEtGrowthItems}> was not found in the response.");
        ...
        public void MultiTeam_Radar_ExportAssessmentChecklist()
        {
