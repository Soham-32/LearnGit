...
using static AgilityHealth_Automation.Tests.AgilityHealth.Teams.EnterpriseTeam.EnterpriseTeamDownloadMembersUploadTemplateTests.ColumnSelect;

namespace AgilityHealth_Automation.Tests.AgilityHealth.Teams.EnterpriseTeam
{
    [TestClass]
    [TestCategory("Teams"), TestCategory("Team")]
    public class EnterpriseTeamDownloadMembersUploadTemplateTests : BaseTest
    {
        ...
        public static void ClassSetup(TestContext testContext)
        {
            try
            {
                ...
                _enterpriseTeamId = _setup.GetCompanyHierarchy(Company.Id).GetTeamByName(SharedConstants.EnterpriseTeam).TeamId;
            }
            catch (Exception)
            {
        ...
        public void EnterpriseTeam_TeamMembers_Download_UploadTemplate()
        {
            ...
            editTeamBasePage.NavigateToPage(_enterpriseTeamId.ToString());
        ...
        [TestMethod]
        [TestCategory("TeamAdmin"), TestCategory("CompanyAdmin"), TestCategory("BLAdmin")]
        public void EnterpriseTeam_Stakeholders_Download_UploadTemplate()
        {
            VerifySetup(_classInitFailed);
