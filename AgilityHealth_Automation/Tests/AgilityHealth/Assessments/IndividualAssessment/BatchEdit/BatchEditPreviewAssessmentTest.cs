...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.BatchEdit
{
    ...
    public class BatchEditPreviewAssessmentTest : IndividualAssessmentBaseTest
    {
        ...
        public void BatchEdit_PreviewAssessment()
        {
            ...
            batchEditAssessmentPage.ClickOnPreviewAssessment();
            Driver.SwitchToLastWindow();

            Assert.IsTrue(Driver.Url.Contains("/preview"), "Preview assessment page should be displayed");
        }
