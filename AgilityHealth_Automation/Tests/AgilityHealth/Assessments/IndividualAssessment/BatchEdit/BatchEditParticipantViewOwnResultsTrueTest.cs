...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.BatchEdit
{
    ...
    public class BatchEditParticipantViewOwnResultsTrueTest : IndividualAssessmentBaseTest
    {
        ...
        public static void ClassSetup(TestContext _)
        {
            ...
            try
            {
                ...
                _assessmentResponse.AllowResultView = false;
        ...
        public void BatchEdit_Participant_ViewOwnResults_True()
        {
            ...
            //assert
            Log.Info("Assert: Verify that check box is active for 'View Own Results'");
            var checkBox= batchEditParticipantReviewerPage.IsParticipantCheckboxChecked(SharedConstants.ParticipantAllowResultView);
            Assert.IsTrue(checkBox, "'View Own Results' checkbox is not checked");
            ...
            //assert
            Log.Info("Assert: Verify that radar is accessible");
            Assert.IsTrue(radar, "The radar is not accessible when it should be");
        }
    }
}