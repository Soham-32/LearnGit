...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.BatchEdit
{
    ...
    public class BatchEditAddAggregateViewerTests : IndividualAssessmentBaseTest
    {
        ...
        public static void ClassSetup(TestContext _)
        {
            try
            {
                ...
                _assessmentResponse.Members = _team.Members.Select(m => MemberResponseExtensions.ToAddIndividualMemberRequest(m)).ToList();
        ...
        public void BatchEdit_Add_AggregateViewer_Single()
        {
            ...
            //assert
            Assert.That.ListsAreEqual(viewerEmails, aggregateViewer, "Individual/Aggregate viewer info does not match");
        }
    }
}