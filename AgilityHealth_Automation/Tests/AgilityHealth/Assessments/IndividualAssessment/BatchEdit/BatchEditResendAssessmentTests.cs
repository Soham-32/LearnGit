...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.BatchEdit
{
    ...
    public class BatchResendAssessmentTests : IndividualAssessmentBaseTest
    {
        ...
        public static void ClassSetup(TestContext _)
        {
            try
            {
                ...
                _team = GetTeamForBatchEdit(setup, "BatchEditResend");
        ...
        [TestMethod]
        [TestCategory("KnownDefect")] //Bug Id- 43538
        [TestCategory("CompanyAdmin"), TestCategory("TeamAdmin"), TestCategory("BLAdmin"), TestCategory("OrgLeader")]
        public void BatchEdit_ResendAssessment()
        {
            ...
            batchEditParticipantReviewerPage.ResendAssessment();

            Assert.AreEqual("Reviewer email has been sent", batchEditParticipantReviewerPage.GetToasterMessage(), "Toaster message for reviewer is not showing properly");
