...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.BatchEdit
{
    ...
    public class BatchEditFlowOfSingleAggregateViewerTest : IndividualAssessmentBaseTest
    {
        ...
        public void BatchEdit_ViewersTab_AggregateViewer_Single()
        {
            ...
            //assert
            Assert.That.ListsAreEqual(_assessmentResponse.AggregateViewers.Select(i => i.Email).ToList(), aggregateViewer, "Aggregate viewer info does not match");
        }
    }
}