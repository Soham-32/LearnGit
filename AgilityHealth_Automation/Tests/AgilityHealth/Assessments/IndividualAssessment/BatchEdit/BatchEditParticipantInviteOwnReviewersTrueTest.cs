...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.BatchEdit
{
    ...
    public class BatchEditParticipantInviteOwnReviewersTrueTest : IndividualAssessmentBaseTest
    {
        ...
        public static void ClassSetup(TestContext _)
        {
            ...
            try
            {
                ...
                _team = GetTeamForBatchEdit(setup, "BatchEditInviteOwnReviewerTrue", 1, _member);
        ...
        public void BatchEdit_Participant_InviteOwnReviewer_True()
        {
            ...
            //assert
            Log.Info("Assert: Verify that check box is active for 'Invite their own reviewers'");
            ...
            //assert
            Log.Info("Assert: Verify that edit link exists");
            Assert.IsTrue(radar, "The edit link does not exist");
        }
    }
}