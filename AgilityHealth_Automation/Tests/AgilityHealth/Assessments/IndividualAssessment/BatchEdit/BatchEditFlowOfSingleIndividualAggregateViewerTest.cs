...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.BatchEdit
{
    ...
    public class BatchEditFlowOfSingleIndividualAggregateViewerTest : IndividualAssessmentBaseTest
    {
        ...
        public void BatchEdit_ViewersTab_IndividualAggregateViewer_Single()
        {
            ...
            //assert
            Assert.That.ListsAreEqual(_assessmentResponse.IndividualViewers.Select(i => i.Email).ToList(), individualViewer, "Individual/Aggregate viewer info does not match");
        }
    }
}