...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.BatchEdit
{
    ...
    public class BatchEditFlowOfMultipleIndividualAggregateViewerTest : IndividualAssessmentBaseTest
    {
        ...
        public static void ClassSetup(TestContext _)
        {
            try
            {
                ...
                _assessmentResponse.IndividualViewers.Add(member2.ToAddUserRequest());
        ...
        public void BatchEdit_ViewersTab_IndividualAggregateViewer_Multiple()
        {
            ...
            Assert.That.ListsAreEqual(_assessmentResponse.IndividualViewers.Select(i => i.Email).ToList(), individualViewer, "The list of individual/aggregate viewers do not match");
        }
    }
}