...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.BatchEdit
{
    ...
    public class BatchEditIndividualAggregateViewerViewRadarTest : IndividualAssessmentBaseTest
    {
        ...
        public void BatchEdit_Add_IndividualAggregateViewer_ViewRadar()
        {
            ...
            Log.Info($"Assert: Verify viewer {_individualAssessViewer1.Username} able to access individual and batch assessments");
            ...
            Assert.IsTrue(individualAssessmentDashboard.IsAssessmentPresent(
                ...
                $"Individual radar doesn't exist with name : {_assessment.AssessmentName}");
        }
    }
}