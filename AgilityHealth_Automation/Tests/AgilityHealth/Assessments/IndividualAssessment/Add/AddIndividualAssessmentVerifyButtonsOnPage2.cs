...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.Add
{
    ...
    public class IndividualAssessmentVerifyButtonsOnPageTwo : IndividualAssessmentBaseTest
    {
        ...
        public void IndividualAssessment_VerifyEnabledButtonsOnPage2()
        {
            ...
            var deleteButtonEnabled = createIndividualAssessment2.IsDeleteButtonEnabled();
            Assert.IsTrue(deleteButtonEnabled, "Delete button is disabled");
            var saveAsDraftButtonEnabled = createIndividualAssessment2.IsSaveAsDraftButtonEnabled();
            Assert.IsTrue(saveAsDraftButtonEnabled, "Save as draft button is disabled");
            var nextButtonEnabled = createIndividualAssessment2.IsNextButtonEnabled();
