...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.Add
{
    ...
    public class AddIndividualAssessmentDeleteParticipantTest : IndividualAssessmentBaseTest
    {
        ...
        public void IndividualAssessment_DeleteParticipant()
        {
            ...
            Log.Info("Assert: Verify that deleted participant doesn't display in reviewers list");
            Assert.IsFalse(createIndividualAssessment2.DoesParticipantDisplay(Constants.TeamMemberEmail2),
                $"Deleted participant {Constants.TeamMemberEmail1} should not display in reviewers list");
        }
    }
}