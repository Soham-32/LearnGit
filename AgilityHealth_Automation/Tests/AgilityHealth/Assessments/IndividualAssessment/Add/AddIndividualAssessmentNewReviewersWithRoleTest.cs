...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.Add
{
    ...
    public class AddIndividualAssessmentNewReviewersWithRoleTest : IndividualAssessmentBaseTest
    {
        ...
        public void IndividualAssessment_AddNewReviewersWithRole()
        {
            ...
            Assert.IsTrue(createIndividualAssessment2.DoesReviewerDisplayCreateIaAddReviewerList($"{newReviewer.FirstName} {newReviewer.LastName}", newReviewer.Email, newReviewer.RoleTags[0].Tags),
            ...
            Log.Info("Assert: Verify that added reviewer with roles displays in reviewers list in review screen");
            Assert.IsTrue(createIndividualAssessment4.DoesReviewerDisplayCreateIaPublishReviewerList($"{newReviewer.FirstName} {newReviewer.LastName}", newReviewer.Email, newReviewer.RoleTags[0].Tags),
                $"Added reviewer {newReviewer.Email} with roles doesn't display in reviewers list in review screen");
        }
    }
}
