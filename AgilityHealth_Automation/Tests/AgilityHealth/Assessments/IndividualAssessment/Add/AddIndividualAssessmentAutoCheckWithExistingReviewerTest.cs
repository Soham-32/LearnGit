...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.Add
{
    ...
    public class AddIndividualAssessmentAutoCheckWithExistingReviewerTest : IndividualAssessmentBaseTest
    {
        ...
        public void IndividualAssessment_AutoCheckVerification_NewReviewer_Existing()
        {
