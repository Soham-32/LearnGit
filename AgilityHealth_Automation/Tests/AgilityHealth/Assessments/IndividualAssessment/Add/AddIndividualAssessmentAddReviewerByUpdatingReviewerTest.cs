...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.Add
{
    ...
    public class AddReviewerByUpdatingReviewerTest : IndividualAssessmentBaseTest
    {
        ...
        public void IndividualAssessment_UpdateReviewers()
        {
            ...
            var assessment = IndividualAssessmentFactory.GetUiIndividualAssessment($"UpdatedReviewerIA_{Guid.NewGuid()}");
            ...
            _reviewer.FirstName = $"UpdatedReviewerName{Guid.NewGuid()}";
