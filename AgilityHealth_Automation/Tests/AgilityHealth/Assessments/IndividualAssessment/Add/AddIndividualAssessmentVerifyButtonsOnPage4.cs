...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.IndividualAssessment.Add
{
    ...
    public class IndividualAssessmentVerifyButtonsOnPageFour : IndividualAssessmentBaseTest
    {
        ...
        public void IndividualAssessment_VerifyEnabledButtonsOnPage4()
        {
            ...
            Assert.IsTrue(saveAsDraftButtonEnabled, "Save as draft button is enabled");
        }
    }
}
