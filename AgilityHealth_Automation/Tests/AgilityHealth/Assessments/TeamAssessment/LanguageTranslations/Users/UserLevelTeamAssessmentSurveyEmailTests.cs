...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.TeamAssessment.LanguageTranslations.Users
{
    ...
    public class UserLevelTeamAssessmentSurveyEmailTests : LanguageTranslationsBaseTest
    {
        ...
        public static string OtherLanguage = ManageRadarFactory.SelectTranslatedLanguage(new List<string>() { Language, "Polish" });
        ...
        public void TeamAssessment_SurveyEmail_AtUserLevel_ForDifferentLanguages()
        {
            ...
            CreateAssessmentAndVerifyEmail(Language, TranslationAdmin.CompanyName, _team.Name, _team.Members.FirstOrDefault());
        }
    }
}