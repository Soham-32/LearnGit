...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.TeamAssessment.LanguageTranslations.Company
{
    ...
    public class CompanyLevelTeamAssessmentSetupEmailTests : LanguageTranslationsBaseTest
    {
        ...
        public void TeamAssessment_SetupEmail_AtCompanyLevel_ForDifferentLanguages()
        {
            ...
            CreateAssessmentAndVerifySetupEmail(Language, _companyRequest.Name, teamInfo.TeamName, teamMemberDetails);
        }
