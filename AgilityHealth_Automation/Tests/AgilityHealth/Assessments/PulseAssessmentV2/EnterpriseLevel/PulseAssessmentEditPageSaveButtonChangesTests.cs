...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.PulseAssessmentV2.EnterpriseLevel
{
    ...
    public class PulseAssessmentEditPageSaveButtonChangesTests : PulseV2BaseTest
    {
        ...
        public static void ClassSetup(TestContext _)
        {
            try
            {
                ...
                _teamWithTeamMemberResponses = _setupApi.GetTeamWithTeamMemberResponse(_enterpriseHierarchyResponses.TeamId).ToList();
                ...
                _draftPulseRequest = PulseV2Factory.PulseAssessmentV2AddRequest(_filteredQuestions, _team1WithMembers, _enterpriseHierarchyResponses.TeamId, false);

                //Create a Active Pulse
                _activePulseRequest = PulseV2Factory.PulseAssessmentV2AddRequest(_filteredQuestions, _team2WithMembers, _enterpriseHierarchyResponses.TeamId);
                ...
                _closedPulseRequest = PulseV2Factory.PulseAssessmentV2AddRequest(_filteredQuestions, _team4WithMembers, _enterpriseHierarchyResponses.TeamId);
        ...
        public void PulseV2_DraftPulse_SaveButtonEnableDisable_Verification_EnterpriseTeamLevel()
        {
        ...
        public void PulseV2_ActivePulse_SaveButtonEnableDisable_Verification_EnterpriseTeamLevel()
        {
            VerifySetup(_classInitFailed);
        ...
        public void PulseV2_PendingPulse_SaveButtonEnableDisable_Verification_EnterpriseTeamLevel()
        {
            VerifySetup(_classInitFailed);
        ...
        public void PulseV2_ClosedPulse_SaveButtonEnableDisable_Verification_EnterpriseTeamLevel()
        {
            VerifySetup(_classInitFailed);
