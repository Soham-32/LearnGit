...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.PulseAssessmentV2.EnterpriseLevel
{
    ...
    public class PulseAssessmentV2AddMemberVerificationEnterpriseLevelTests : PulseV2BaseTest
    {
        ...
        public static void ClassSetup(TestContext _)
        {
            try
            {
                ...
                _enterpriseHierarchyResponses = _setupApi.GetCompanyHierarchy(Company.Id).GetTeamByName(_enterpriseTeamResponse.Name);

                _setupApi.GetTeamWithTeamMemberResponse(_enterpriseHierarchyResponses.TeamId);

                _setupApi.GetTeamWithTeamMemberResponse(_enterpriseHierarchyResponses.TeamId);

                GetQuestions(_enterpriseHierarchyResponses.TeamId);
        ...
        public void PulseV2_AddMember_DraftPulse_EnterpriseTeamLevel()
        {
        ...
        public void PulseV2_AddMember_ActivePulse_EnterpriseTeamLevel()
        {
            VerifySetup(_classInitFailed);
            var login = new LoginPage(Driver, Log);
        ...
        public void PulseV2_AddMember_PendingPulse_EnterpriseTeamLevel()
        {
            VerifySetup(_classInitFailed);
            var login = new LoginPage(Driver, Log);
        ...
        public void PulseV2_AddMember_ClosedPulse_EnterpriseTeamLevel()
        {
            VerifySetup(_classInitFailed);
            var login = new LoginPage(Driver, Log);
