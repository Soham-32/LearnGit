...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.PulseAssessmentV2.EnterpriseLevel
{
    ...
    public class PulseAssessmentV2ActiveAndClosedPulseAddRemoveTeamEnterpriseLevelTests : PulseV2BaseTest
    {
        ...
        public static void ClassSetup(TestContext _)
        {
            try
            {
                ...
                _activePulseRequest = PulseV2Factory.PulseAssessmentV2AddRequest(_filteredQuestions, _team1WithMembers, _enterpriseHierarchyResponses.TeamId, period: AssessmentPeriod.OneWeek);

                //Pulse request for Closed Pulse
                _closedPulseRequest = PulseV2Factory.PulseAssessmentV2AddRequest(_filteredQuestions, _team2WithMembers, _enterpriseHierarchyResponses.TeamId, period: AssessmentPeriod.SeventyTwoHours);
        ...
        public void PulseV2_ActivePulse_AddAndRemoveTeams_Verification_EnterpriseTeamLevel()
        {
        ...
        public void PulseV2_ClosedPulse_AddAndRemoveTeams_Verification_EnterpriseTeamLevel()
        {
            VerifySetup(_classInitFailed);
            var login = new LoginPage(Driver, Log);
            ...
            TeamResponse team)
        {
            ...
            mtEtDashboard.NavigateToPage(_enterpriseHierarchyResponses.TeamId, true);
