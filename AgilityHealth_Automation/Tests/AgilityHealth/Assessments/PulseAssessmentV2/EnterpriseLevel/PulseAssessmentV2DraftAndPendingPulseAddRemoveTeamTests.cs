...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Assessments.PulseAssessmentV2.EnterpriseLevel
{
    ...
    public class PulseAssessmentV2DraftAndPendingPulseAddRemoveTeamTests : PulseV2BaseTest
    {
        ...
        public static void ClassSetup(TestContext _)
        {
            try
            {
                ...
                _pendingPulseRequest = PulseV2Factory.PulseAssessmentV2AddRequest(_filteredQuestions,
                    _team2WithMembers, _enterpriseHierarchyResponses.TeamId, true, null,
        ...
        public void PulseV2_DraftPulse_AddAndRemoveTeams_Verification_EnterpriseTeamLevel()
        {
        ...
        public void PulseV2_PendingPulse_AddAndRemoveTeams_Verification_EnterpriseTeamLevel()
        {
            VerifySetup(_classInitFailed);
            var login = new LoginPage(Driver, Log);
