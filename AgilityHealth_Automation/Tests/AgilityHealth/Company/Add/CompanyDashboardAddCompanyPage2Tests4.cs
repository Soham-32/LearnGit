...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Company.Add
{
    ...
    public class CompanyDashboardAddCompanyPage2Tests4 : BaseTest
    {
        private static AddCompanyRequest _companyRequest;

        [TestMethod]
        [TestCategory("SiteAdmin"), TestCategory("PartnerAdmin")]
        public void CompanyDashboard_AddCompany_Page2_Delete()
        {
            ...
            _companyRequest = CompanyFactory.GetCompany("ZZZ_Add4UI", User.CompanyName);
            ...
            addCompanyPage2.Header.ClickDeleteButton();
            companyDashboardPage.WaitUntilLoaded();
