...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Company.Add
{
    ...
    public class CompanyDashboardAddCompanyPage3Tests2 : BaseTest
    {
        private static AddCompanyRequest _companyRequest;

        [TestMethod]
        [TestCategory("SiteAdmin"), TestCategory("PartnerAdmin")]
        public void CompanyDashboard_AddCompany_Page3_Delete()
        {
            ...
            _companyRequest = CompanyFactory.GetCompany("ZZZ_Add7UI", User.CompanyName);
