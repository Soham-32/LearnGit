...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Company.Edit
{
    ...
    public class CompanyRadarSelectionEditTests2 : CompanyEditBaseTest
    {
        ...
        public void Company_UpdateRadarSelection_Cancel()
        {
            ...
            radarSelectionPage.Header.ClickCancelButton();
            companyDashboardPage.WaitUntilLoaded();
            ...
            Assert.IsFalse(radarSelectionPage.IsRadarChecked(radarName), 
                $"The radar <{radarName}> should NOT be checked.");
