...
namespace AgilityHealth_Automation.Tests.AgilityHealth.Company.Edit
{
    ...
    public class CompanyProfileEditTests4 : CompanyEditBaseTest
    {
        ...
        public void Company_UpdateCompanyProfile_SaveAsDraft_Cancel()
        {
            ...
            editCompanyProfilePage.Header.ClickCancelButtonOnPopup();
            ...
            Assert.AreEqual(_companyRequest.Country, actualCompanyProfile.Country, 
