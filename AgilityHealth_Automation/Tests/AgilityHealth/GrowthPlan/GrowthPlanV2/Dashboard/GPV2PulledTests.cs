...
namespace AgilityHealth_Automation.Tests.AgilityHealth.GrowthPlan.GrowthPlanV2.Dashboard
{
    ...
    public class Gpv2PulledTests : BaseTest
    {
        ...
        public static void ClassSetup(TestContext testContext)
        {
            ...
            setup.PullGi(_multiTeam.TeamId, GrowthItemInfo.Title,TeamType.MultiTeam);
            ...
            setup.PullGi(_enterpriseTeam.TeamId, GrowthItemInfo2.Title,TeamType.EnterpriseTeam);
        }

        [TestMethod]
        [TestCategory("CompanyAdmin")]
        public void GPV2_PulledFromAssessmentToMtLevel()
        {
        ...
        [TestMethod]
        [TestCategory("CompanyAdmin")]
        public void GPV2_PulledFromMtToEtLevel()
        {
            var login = new LoginPage(Driver, Log);
            var growthPlanDashboard = new GrowthPlanDashboardPage(Driver, Log);
