...
namespace AgilityHealth_Automation.Tests.AgilityHealth.GrowthPlan.GrowthPlanV2.Delete
{
    [TestClass]
    [TestCategory("GrowthPlanV2"), TestCategory("GrowthPlan")]
    public class GrowthPlanDeleteItemTest1 : BaseTest
    {
        ...
        public void GPV2_Item_Delete_Successfully()
        {
            ...
            growthPlanAddItemPage.ClickOnDeleteButton();
            growthPlanAddItemPage.ConfirmationDeletePopUpClickOnCancelButton();
            Assert.IsTrue(growthPlanAddItemPage.IsGrowthPlanTitleDisplayed(), "'Add Growth Item' popup is closed");

            growthPlanAddItemPage.ClickOnDeleteButton();
            growthPlanAddItemPage.ConfirmationDeletePopUpClickOnDeleteButton();
            Assert.IsFalse(growthPlanDashboard.IsGrowthItemDisplayed(_growthPlanItemRequest.Title,true), $"{_growthPlanItemRequest.Title} is still exist");
        }
    }
}
