...
namespace AgilityHealth_Automation.Tests.AgilityHealth.GrowthPlan.GrowthPlanV2.Edit
{
    ...
    public class GrowthPlanEditItemTest3 : BaseTest
    {
        ...
        public void GPV2_Item_Edit_Verify_Popup_Opened_WhileClickOnAnyColumnValueOfGi()
        {
            ...
            {
                growthPlanDashboard.ClickOnColumnValueByGiTitleName(_growthPlanItemRequest.Title, column);
                Assert.IsTrue(growthPlanAddItemPage.IsGrowthPlanTitleDisplayed(), "'Add Growth Plan' pop up is not opened");
