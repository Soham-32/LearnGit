...
namespace AgilityHealth_Automation.Tests.AgilityHealth.NewNavigation.TeamDashboard
{
    ...
    public class TeamDashboardSortingPortfolioTeamTests : BaseTest
    {
        [TestMethod]
        [TestCategory("ColumnSorting")]
        [TestCategory("CompanyAdmin")]
        [TestCategory("KnownDefect")]//Bug 49586
        public void TeamDashboard_GridView_ColumnSorting_PortfolioTeam()
        {
            ...
            Log.Info("Select the 'Portfolio Team' from 'Level' dropdown and add all column");
            dashboardPage.FilterTeamType("Portfolio Team");
