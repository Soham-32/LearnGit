...
namespace AgilityHealth_Automation.Tests.AgilityHealth.NewNavigation.TeamDashboard
{
    ...
    public class TeamDashboardSortingMultiTeamTests : BaseTest
    {
        ...
        public void TeamDashboard_GridView_ColumnSorting_MultiTeam()
        {
            ...
            Log.Info("Select the 'Multi-Team' from 'Level' dropdown and add all column");
            dashboardPage.FilterTeamType("Multi-Team");
            dashboardPage.ClickOnGridColumn("Work Type");
            var multiTeamColumns = new List<string>() { "Team Name", "Work Type", "No of Sub-Teams", "Team Tags", "External ID" , "No of Team Members" };
