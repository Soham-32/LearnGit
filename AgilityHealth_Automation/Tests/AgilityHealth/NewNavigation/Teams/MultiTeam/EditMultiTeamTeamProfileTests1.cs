...
namespace AgilityHealth_Automation.Tests.AgilityHealth.NewNavigation.Teams.MultiTeam
{
    ...
    public class EditMultiTeamTeamProfileTests1 : NewNavBaseTest
    {
        ...
        public static void ClassSetUp(TestContext _)
        {
            try
            {
                _multiTeam = TeamFactory.GetMultiTeam("EditedMT");
                _multiTeam.Members.Add(MemberFactory.GetTeamMember());
        ...
        public void MultiTeam_EditProfile()
        {
            ...
            teamDashboardPage.ClickOnEditTeamButton(_multiTeam.Name);

            var teamInfo = MultiTeamsFactory.GetValidUpdatedMultiTeamInfo();
            ...
            Log.Info("Verify that multi team gets edited properly");
