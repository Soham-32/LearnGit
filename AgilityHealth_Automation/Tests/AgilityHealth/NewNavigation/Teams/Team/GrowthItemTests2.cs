...
namespace AgilityHealth_Automation.Tests.AgilityHealth.NewNavigation.Teams.Team
{
    ...
    public class GrowthItemTests2 : NewNavBaseTest
    {
        ...
        [TestCategory("KnownDefect")] // Bug Id : 47411
        public void GrowthItem_Team_GridView_All_Mandatory_Fields()
        {
            ...
            Log.Info("Expand Enterprise, Portfolio, and Multi-team");
            leftNavPage.ExpandTeam(SharedConstants.EnterpriseTeam);
            leftNavPage.ExpandTeam(SharedConstants.PortfolioTeam);
            leftNavPage.ExpandTeam(SharedConstants.MultiTeam);

            Log.Info("Click on a team");
