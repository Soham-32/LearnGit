...
namespace AgilityHealth_Automation.Tests.AgilityHealth.NewNavigation.Teams.Team
{
    ...
    public class AddTeamReviewStepperTests1 : NewNavBaseTest
    {
        [TestMethod]
        [TestCategory("CompanyAdmin"), TestCategory("TeamAdmin"), TestCategory("BLAdmin")]
        public void Team_FullWizard_Verify_Edit_TeamProfile()
        {
            Verify_Team_ReviewStepper_Edit_TeamProfile(TeamType.FullWizardTeam);
        }
    }
}
