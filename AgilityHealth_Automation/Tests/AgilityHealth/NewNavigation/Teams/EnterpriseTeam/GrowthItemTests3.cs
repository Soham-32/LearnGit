...
namespace AgilityHealth_Automation.Tests.AgilityHealth.NewNavigation.Teams.EnterpriseTeam
{
    ...
    {
        //[TestMethod] -- For now Measure tab is enabled for Enterprise level
        [TestCategory("CompanyAdmin")]
        public void GrowthItem_EnterpriseTeam_AddEditDeleteComment()
        {
            ...
            Log.Info("Click on an enterprise team");
