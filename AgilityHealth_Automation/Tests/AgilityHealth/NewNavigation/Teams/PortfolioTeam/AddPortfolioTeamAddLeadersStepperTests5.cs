...
namespace AgilityHealth_Automation.Tests.AgilityHealth.NewNavigation.Teams.PortfolioTeam
{
    ...
    public class AddPortfolioTeamAddLeadersStepperTests5 : NewNavBaseTest
    {
        ...
        public void PortfolioTeam_Verify_AddFromDirectory_AddMember_Successfully()
        {
            VerifySetup(ClassInitFailed);

            Verify_Team_AddTeamMembersLeadersStepper_AddFromDirectory_AddMemberLeader_Successfully(TeamType.PortfolioTeam, _expectedTeamResponse);
        }
        ...
        [TestCategory("Critical")]
        [TestCategory("CompanyAdmin"), TestCategory("TeamAdmin"), TestCategory("BLAdmin")]
        public void PortfolioTeam_Verify_AddFromDirectory_AddTeam_Successfully()
        {
            VerifySetup(ClassInitFailed);

            Verify_Team_AddTeamMembersLeaders_AddFromDirectory_AddTeam_Successfully(TeamType.PortfolioTeam, _expectedTeamResponse);
        }
    }
}
