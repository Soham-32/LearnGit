...
namespace AgilityHealth_Automation.Tests.AgilityHealth.NewNavigation.Teams.PortfolioTeam
{
    ...
    public class AddPortfolioTeamReviewStepperTests3 : NewNavBaseTest
    {
        [TestMethod]
        ...
        public void Portfolio_Team_Edit_SubTeams()
        {
            Verify_Team_ReviewStepper_Edit_SubTeams(TeamType.PortfolioTeam);
        }
    }
}
