...
{
    internal class AddRadarReviewAndFinishPage : RadarReviewAndFinishBasePage
    {
        public AddRadarReviewAndFinishPage(IWebDriver driver, ILogger log) : base(driver, log)
        {
        }
    }
}